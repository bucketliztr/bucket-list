...
describe UsersController do
  ...
  let(:valid_attributes) { { email: "test@email.com", name: "Test User", location: "Minneapolis", password: "password", password_confirmation: "password" } }
  let(:valid_session) { { email: "test@email.com", password: "password", password_confirmation: "password"} }
